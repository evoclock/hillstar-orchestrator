...
def cmd_execute(args):
	...
	print("ℹ COMPLIANCE NOTICE: All cloud providers use API authentication. Users are responsible for provider ToS compliance.")
	print()
...
# print()
# print("ℹ This diagram can be copied into Markdown, GitHub, or Claude Code.")
# print()
#
# if args.summary:
...
Examples:
	...
	hillstar enforce status # Check governance compliance
	"""
	)
	...
	# PHASE 2: execute-node command deferred (WorkflowRunner.execute_node() not yet implemented)
...
# PHASE 2 FEATURE: cmd_execute_node deferred (WorkflowRunner.execute_node() not yet implemented)
